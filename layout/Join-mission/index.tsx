    ...
    >
      <div className="container mx-auto  md:px-0 px-3">
        ...
        <p className="flex items-center justify-center text-center font mt-6 text-[#00304CCC]">
          Find a story that moves you and contribute to our ongoing goals. With
          Give A Meal, <br />
      ...
      >
        ...
        >
          ...
          <p className="font mt-6 text-[#00304CCC] truncate">
            Shared meals will provide hot meals, monthly <br /> food baskets and
            nutrition supplements to <br /> families in Northern Nigeria...
          </p>
