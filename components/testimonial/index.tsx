...
export default function TestimonialCard() {
  ...
  return (
    <div className="mt-15">
      {/* Title */}
      <div className="text-center space-y-4 md:px-0 px-3 max-w-md mx-auto">
        <h1 className="font text-[#00304C] text-3xl font-semibold">
          The Power Of Giving
        </h1>
        <p className="font text-[#00304CCC] ">
          Discover why thousands of donors choose Give A Meal to make a
          difference every day.
        </p>
      </div>

      <div className="relative p-8">
        <div className="flex flex-col items-center justify-center py-10 px-4 z-99 bg-white">
          <div className="relative w-full max-w-2xl bg-white rounded-xl shadow-sm p-8 md:p-10 text-cente fle md:flex-col  md:items-center md:justify-between">
            ...
            <div className="md:flex mt-5">
              <div className="md:pr-8">
                <p className="text-gray-700 leading-relaxed mb-6 font">
                  {text}
                </p>
              </div>
